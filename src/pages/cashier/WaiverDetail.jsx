...
export function WaiverDetail() {
  return (
    <div style={{ flex: 1, minWidth: 0, minHeight: 0, display: "flex", overflow: "hidden" }}>
      <div style={{ flex: 1, minWidth: 0, minHeight: 0, padding: "24px 28px", overflowY: "auto" }}>
        ...
        <div style={{ background: "#fff", border: "1.5px solid var(--ink-200)", borderRadius: 14, padding: "18px", marginBottom: 20 }}>
          ...
          <div style={{ background: "var(--ink-50)", border: "1.5px solid var(--ink-100)", borderRadius: 14, padding: "20px 24px", fontSize: 14, lineHeight: 1.6, color: "var(--ink-700)", maxHeight: 200, overflow: "auto" }}>
            <div style={{ fontWeight: 800, fontSize: 16, color: "var(--ink-800)", fontFamily: "var(--font-display)" }}>Movira Liability Waiver</div>
      ...
      <aside style={{ width: "clamp(340px, 30vw, 460px)", flexShrink: 0, minHeight: 0, padding: "24px 22px", background: "var(--ink-50)", borderLeft: "1px solid var(--ink-100)", display: "flex", flexDirection: "column", gap: 14, overflowY: "auto" }}>
